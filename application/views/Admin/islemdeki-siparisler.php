								...
								<div class="col-xl-12">
									<div class="card plan-list">
										<div class="card-header d-sm-flex flex-wrap d-block pb-0 border-0">
											...
											<a href="<?php echo base_url("admin/tumsiparisler")?>" class="btn rounded btn-primary mb-3">
											...
											<?php foreach($orders as $key=>$order) {
												...
												<div class="d-flex flex-wrap pt-3 list-row align-items-center mb-2 border-bottom">
													...
													<div class="col-xl-5 col-xxl-12 col-lg-4 col-sm-12 d-flex align-items-center">
														<?php
													if($order["durum"]=="onay_beklemede"){ ?>
														<a href="<?php echo base_url("admin/siparisonayla/".$order["id"]) ?>" class="btn mb-3 play-button rounded mr-3 siparis-onaylandi">
														...
														<div class="dropdown mb-3 ">
															...
															<a class="dropdown-item" href="<?php echo base_url("staff/orderdetail/".$order["id"]."/".$order["aldigi_urun"])?>">Ürün Bilgisi</a>
																<hr class="m-1">
																<a class="dropdown-item text-success" href="<?php echo base_url("admin/urundurum/".$order["id"]."/1/".$order["alan"]."/".$order["aldigi_urun"])?>">Ürün Teslim Edildi</a>
																<a class="dropdown-item text-warning" href="<?php echo base_url("admin/urundurum/".$order["id"]."/2/".$order["alan"]."/".$order["aldigi_urun"]."/?d=hazirlaniyor")?>">Ürün Hazırlanıyor</a> 
																<a class="dropdown-item text-black" href="<?php echo base_url("admin/urundurum/".$order["id"]."/2/".$order["alan"]."/".$order["aldigi_urun"]."/?d=kargo")?>">Ürün Kargoda</a>
																<a class="dropdown-item text-danger" href="<?php echo base_url("admin/cancelorderback/".$order["id"]."/".$order["alan"]."/".$order["aldigi_urun"])?>">Siparişi İptal Et</a></div>
														</div>
													</div> 
												</div>
											<?php }} ?>
