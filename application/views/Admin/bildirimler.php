...
$.ajax({
type: 'POST',
url: '<?php echo base_url('admin/oku')?>',
data: null,
success: $('#hipul').hide()
    ...
    <div class="dropdown-menu rounded dropdown-menu-right" style="padding: 0 !important;">
        <div id="DZ_W_Notification1" class="widget-media dz-scroll p-3 height380">
            <ul class="timeline">
                ...
                <?php if($bildirim["type"]=="talep_olustu") { ?> 
                    <li> 
                <a href="<?php echo base_url("admin/viewticket?ticketId=".$bildirim["hangi_talep"]) ?>"><div class="timeline-panel">
                ...
                <?php if($bildirim["type"]=="talep_yanit") { ?> 
                    <li>
                <a href="<?php echo base_url("admin/viewticket?ticketId=".$bildirim["talep_id"]) ?>">
                <div class="timeline-panel">
                    ...
                    <div class="media-body">
                        ...
                        <small class="d-block">Talep ID: <?php echo $bildirim["talep_id"] ?></small>
                        <small class="d-block"><?php echo $bildirim["tarih"] ?></small>
                    </div>
                </div>
                </a>
                ...
                <?php if($bildirim["type"]=="iptal") { ?> 
                    <li>
              <a href="<?php echo base_url("admin/orderdetail/".$bildirim["siparisId"]."/".$bildirim["urun"]) ?>">
                <div class="timeline-panel">
                <div class="media mr-2 media-danger">
                    ...
                    <div class="media-body">
                        ...
                        <small class="d-block">Ürün ID: <?php echo $bildirim["urun"] ?></small>
                        <small class="d-block"><?php echo $bildirim["tarih"] ?></small>
                    </div>
                </div>
                </a>
