        ...
        <li><a href="<?php echo base_url("admin/borc") ?>">Borç Sil</a></li>
					...
					<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li><a href="<?php echo base_url("admin/viewticket?ticketId=".$_GET["ticketId"]) ?> ">Bileti Görüntüle, ID : <?php echo $_GET["ticketId"] ?></a></li>
                        </ul>
                    </li>
                </ul>
...
';
                                        ...
                                        <div class="list-group-item ticket-yonetimi">
                                            <div class="row">
                                                ...
                                                <div class="col-6 pt-0 pb-0 pr-2 pl-2">
                                                    <div class="p-0">
                                                        <a href="<?php echo base_url("admin/kapat?id=".$ticketx[0]["id"]) ?>" class="col-12 badge badge-sm badge-danger cursor-pointer">
        ...
        <div class="modal fade" id="exampleModalCenter">
            ...
            <div class="modal-content">
                <form enctype="multipart/form-data" action="<?php echo base_url("admin/cevap") ?>" method="post" >    <div class="modal-body pt-2 pb-3 pl-3 pr-3">
                    <input type="hidden" name="toid" value="<?php echo $_GET["ticketId"] ?>">
                    <input type="hidden" name="valo" value="<?php echo $user[0]["isim"]?>">		
                    <input type="hidden" name="user_id" value="<?php echo $ticketx[0]["kim"]?>">		
                                                                                
                <div class="p-0 col-12">
							<p class="m-1 font-15">Ad Soyad</p>
							<input name="val-adsoyad" value="<?php echo $user[0]["isim"] ?>" type="text" class="bradius-025 max-yukseklik form-control input-default input-kapali" placeholder="Talep Oluşturan Kişinin Ad ve Soyadı" disabled="disabled">
						</div>		
                        <div class="p-0 col-12">
