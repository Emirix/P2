...
$.ajax({
type: 'POST',
url: '<?php echo base_url('staff/oku')?>',
data: null,
success: $('#hipul').hide()
        ...
        <div id="DZ_W_Notification1" class="widget-media dz-scroll p-3 height380">
            ...
            <?php foreach ($bildirimler as $bildirim) { ?> 
                    ...
                    <?php if($bildirim["type"]=="talep_olustu") { ?> 
                        <li> 
                    <a href="<?php echo base_url("staff/viewticket?ticketId=".$bildirim["hangi_talep"]) ?>"><div class="timeline-panel">
                    ...
                    <?php if($bildirim["type"]=="talep_yanit") { ?> 
                        <li>
                    <a href="<?php echo base_url("staff/viewticket?ticketId=".$bildirim["talep_id"]) ?>">
                    ...
                    <?php if($bildirim["type"]=="iptal") { ?> 
                        <li>
                  <a href="<?php echo base_url("staff/orderdetail/".$bildirim["siparisId"]."/".$bildirim["urun"]) ?>">
                    <div class="timeline-panel">
