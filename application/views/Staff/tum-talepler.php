                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="pag" class="table table-responsive-md">
                                        <thead>
                                            <tr class="cblack">
                                                ...
                                                <td>
                                                    <?php 
                                                        if($ticket["durum"]=="Kapalı"){
                                                            echo '<span class="badge light badge-danger"><i class="fa fa-circle text-danger mr-1"></i>Kapalı</span>';
                                                        }

                                                        if($ticket["durum"]=="Açık"){
                                                            echo '<span class="badge light badge-success"><i class="fa fa-circle text-success mr-1"></i>Açık</span>';
                                                        }

                                                        if($ticket["durum"]=="MYanit"){
                                                            echo '<span class="badge light badge-primary"><i class="fa fa-circle text-primary mr-1"></i>Müşteri Yanıtı</span>';
                                                        }

                                                        if($ticket["durum"]=="Yanit"){
                                                            echo '<span class="badge light badge-info"><i class="fa fa-circle text-ifno mr-1"></i>Yanıtlandı</span>';
                                                        }
                                                    ?>
												</td>
                                                ...
                                                <td>
													<div class="dropdown">
														...
														<div class="dropdown-menu">
															<a class="dropdown-item text-success" href="<?php echo base_url("staff/viewticket?ticketId=".$ticket["id"]) ?>">Yanıtla</a>
                                                            <?php if($ticket["durum"]!="Kapalı") { ?> 
                                                            <hr class="m-1">
                                                           
															<a class="dropdown-item text-danger" href="<?php echo base_url("staff/kapat?id=".$ticket["id"]) ?>" >Bildirimi Kapat</a>
                                                            <?php } ?>
                                                        </div>
													</div>
												</td>
