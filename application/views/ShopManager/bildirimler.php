<li class="nav-item dropdown notification_dropdown">
    ...
    $.ajax({
  type: 'POST',
  url: '<?php echo base_url('shopmanager/oku')?>',
  data: null,
  success: $('#hipul').hide()
    ...
    <div class="dropdown-menu rounded dropdown-menu-right" style="padding: 0 !important;">
        <div id="DZ_W_Notification1" class="widget-media dz-scroll p-3 height380">
            <ul class="timeline">
                ...
                <li>
                    <?php if($bildirim["type"]=="talep_yanit") { ?> 
                    <a href="<?php echo base_url("shopmanager/ticket?ticketId=".$bildirim["talep_id"]) ?>">
                    <div class="timeline-panel">
                        <div class="media mr-2 media-success">
                            <i class="fa fa-commenting"></i>
                        </div>
                        <div class="media-body">
                            <h6 class="mb-1"><?php echo $this->lang->line("talep_yanit") ?></h6>
                            <small class="d-block"><?php echo $this->lang->line("talep_id") ?> <?php echo $bildirim["talep_id"] ?></small>
                ...
                <li>
                    <?php if($bildirim["type"]=="iptal") { ?> 
                  <a href="<?php echo base_url("shopmanager/orderdetail/".$bildirim["siparisId"]."/".$bildirim["urun"]) ?>">
                    <div class="timeline-panel">
                    <div class="media mr-2 media-danger">
                            <i class="fa fa-close"></i>
                        </div>
                        <div class="media-body">
                            <h6 class="mb-1"><?php echo $this->lang->line("urun_iptal") ?></h6>
                ...
                <li>
                    <?php if($bildirim["type"]=="hazirlaniyor") { ?> 
                  <a href="<?php echo base_url("shopmanager/orderdetail/".$bildirim["siparisId"]."/".$bildirim["urun"]) ?>">
                    <div class="timeline-panel">
                    <div class="media mr-2 media-info">
                        ...
                        <div class="media-body">
                        <h6 class="mb-1"><?php echo $this->lang->line("urun_hazirlaniyor") ?></h6>
                            <small class="d-block"><?php echo $this->lang->line("urun_id") ?>: <?php echo $bildirim["urun"] ?></small>
                            <small class="d-block"><?php echo $bildirim["tarih"] ?></small>
                        </div>
                    </div>
                ...
                <li>
                  ...
                  <div class="timeline-panel">
                        ...
                        <div class="media-body">
                            <h6 class="mb-1"><?php echo $this->lang->line("urun_ok") ?></h6>
                            <small class="d-block"><?php echo $this->lang->line("urun_id") ?>: <?php echo $bildirim["urun"] ?></small>
                            <small class="d-block"><?php echo $bildirim["tarih"] ?></small>
                        </div>
                    </div>
                ...
                <li>
                    <?php if($bildirim["type"]=="kargo") { ?> 
                  <a href="<?php echo base_url("shopmanager/orderdetail/".$bildirim["siparisId"]."/".$bildirim["urun"]) ?>">
                  <div class="timeline-panel">
                        <div class="media mr-2 media-gray">
                            <i class="fa fa-check"></i>
                        </div>
                        <div class="media-body">
                            <h6 class="mb-1"><?php echo $this->lang->line("urun_kargo") ?></h6>
                            <small class="d-block"><?php echo $this->lang->line("urun_id") ?>: <?php echo $bildirim["urun"] ?></small>
                            <small class="d-block"><?php echo $bildirim["tarih"] ?></small>
                        </div>
                    </div>
